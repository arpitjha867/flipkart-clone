  ...
  return (
    <div className=' my-3' style={{
      ...
      <div className="box" style={{
        ...
        <h6 className='infoParaHeaedings'>Flipkart: The One-stop Shopping Destination</h6>
        ...
        <h6 className='infoParaHeaedings'>Flipkart Plus</h6>
...
Check out https://www.flipkart.com/plus/all-offers for the entire list. Terms and conditions apply.
        ...
        <h6 className='infoParaHeaedings'>No Cost EMI</h6>
        ...
        <h6 className='infoParaHeaedings'>EMI on Debit Cards</h6>
        ...
        <h6 className='infoParaHeaedings'>Mobile Exchange Offers</h6>
...
How about jazzing up your phone with our quirky designer cases and covers? Our wide-ranging mobile accessories starting from headphones, power banks, memory cards, mobile chargers, to selfie sticks can prove to be ideal travel companions for you and your phone; never again worry about running out of charge or memory on your next vacation.
        ...
        <h6 className='infoParaHeaedings'>Large Appliances</h6>
        ...
        <h6 className='infoParaHeaedings'>Small Home Appliances</h6>
        ...
        <h6 className='infoParaHeaedings'>Lifestyle</h6>
        ...
        <h6 className='infoParaHeaedings'>Home and Furniture</h6>
...
You may have your furniture all set up, but they could end up looking flat and incomplete without complementary decor. Curtains, cushion covers, bed sheets, wall shelves, paintings, floor lamps - find everything that turns a house to an inviting home under one roof at Flipkart.
        ...
        <h6 className='infoParaHeaedings'>Baby and Kids</h6>
        ...
        <h6 className='infoParaHeaedings'>Books, Sports and Games</h6>
        ...
        <h6 className='infoParaHeaedings'>Grocery/Supermart</h6>
        
        <p className='infoParaGraph'>
        Launching into the grocery vertical, Flipkart introduces<strong>Supermart</strong>  that is out to bring everyday essentials close to you. From pulses, spices, dairy, personal and sanitary care, breakfast essentials, health drinks, spreads, ready to cook, grooming to cleaning agents, we are happy to present everything you need to run a house. Now buy Grocery products for as low as 1 Rupee only - our<strong>1 Rupee Store</strong>  presents new products every day for a nominal price of 1 Rupee only. Terms and conditions apply.
